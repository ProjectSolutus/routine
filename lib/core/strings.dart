class AppStrings {
  ...
  static const String slideOneDescription =
      "Routine is a free, open-source app for seamless task and habit tracking, prioritizing privacy.";
  ...
  static const String slideTwoDescription =
      "Take control with Routine: prioritize, categorize, and organize tasks to boost productivity.";
  ...
  static const String slideThreeDescription =
      "Turn aspirations into habits with Routine: set goals, track progress, and celebrate achievements.";
  ...
  static const String slideFourDescription =
      "Routine is a free, open-source tool committed to privacy, keeping your data secure and ad-free.";
